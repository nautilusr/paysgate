...
class VietCombank
{
    protected $captcha1st = '5456dd091eb54cedbcfe5fa667d79b1b';
    ...
    protected $E = "";
    protected $tranId = "";
    protected $bankCode = "VCB";
    protected $bankName = "VIETCOMBANK";
    ...
    public function saveData(){
        ...
        $client->request('POST', 'http://host.docker.internal:3000/api/account', [
            'headers' => $headers,
            'json' => $data
        ]);
    }
    public function sendTest($data){
        ...
        $client->request('POST', 'http://host.docker.internal:3000/api/test', [
            'headers' => $headers,
            'json' => $data
        ]);
    }
    ...
    public function solveCaptcha(){
        ...
        $result = $this->createTask($getCaptcha);
        if ($result !== false) {
          if ($result->Code == 0) {
            sleep(3);
            $result = $this->getTaskResult($result->TaskId);
